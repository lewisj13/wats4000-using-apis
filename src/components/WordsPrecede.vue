<template>
  ...
  <p>
    ...
    <form v-on:submit.prevent="findWords">
      <p>Find words that precede this word <input type="text" v-model="phrase">   <button type="submit">Search</button></p>
    </form>
...
export default {
  ...
  methods: {
    findWords: function(){
      axios.get('https://api.datamuse.com/words?rel_bgb=statue', {
        params: {
          rel_bgb: this.phrase,
        }
      })
